  ...
  return (
    <View className="flex-1 bg-[#FFF8E3] flex-col items-center pt-2 px-5">
      ...
      <View className="mt-8 mb-6 items-center px-4">
        <Text className="text-[24px] font-poppins-regular font-bold text-[#AC3C00] text-center mb-2">Add your schedule</Text>
        <Text className="text-[14px] font-poppins-regular text-[#646982] text-center leading-5">Choose the sources you want to connect.</Text>
      </View>
              ...
              return (
                ...
                >
                  ...
                  <View className="flex-1">
                    <Text className={`font-poppins-regular text-[14px] font-bold ${!isSelected ? 'text-primary' : 'text-[#ffffff]'}`}>{cal.title}</Text>
                    <Text className={`font-poppins-regular text-[12px] font-bold ${!isSelected ? 'text-[#646982]' : 'text-[#ffefe6ff]'}`}>
                      {cal.source.name}
                    </Text>
                  </View>
