...
export default function FolderCard({ title, link, onPress, isActive, icon, rightIcon }: FolderCardProps) {
  // Logic màu nền:
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <Text className={`flex-1 font-sen font-bold text-sm uppercase ${textColor}`}>{title}</Text>
